...
class Console:
    ...
    def show_dev_info(self):
        ...
        title = text2art("DAWN BOT", font="small")
        styled_title = Text(title, style="bold cyan")

        version = Text("VERSION: 1.6", style="blue")
        telegram = Text("Github : Rambeboy", style="yellow")
        github = Text("Author : Nofan Rambe", style="yellow")
        ...
        dev_panel = Panel(
            ...
            subtitle="[italic]Powered by Rambeboy[/italic]",
        )
